...
# print('Wed) SyntaxError: unterminated string literal (detected at line 5)
...
'''
# user_input = int(input("Price of a product: "))
# sales_tax_rate = 0.7
# calculate_final_price = user_input * sales_tax_rate + user_input
# print(calculate_final_price)


# Function

# def taxes(user_input):
